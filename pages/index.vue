    ...
    <div class="ph5 pv6 h-85vh">
        <div class="w-100 flex flex-row">
                    ...
                    <div class="text-center">
                        <div class="hover-princp">
                            ...
                            <div class="popup-princp popup">
                                <p>active with integrity and honesty, with a strong sense of fairness, justice and respect.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-20 text-right">
                ...
                <p>pointing us in the right direction</p>
                <p>. . . .</p>
                <p>on the hunt and sharing facts</p>
                <br>
            </div>
        </div>
    </div>
